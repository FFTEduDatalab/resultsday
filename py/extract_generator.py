...
scope='EN16'		# XXX
gender='All students'
grade='7/A or above'		# XXX
# exclusions=['LEIS', 'AOTH', 'HSOC', 'HOME', 'MANU', 'HOSP', 'BUSC' ,'WELS', 'WELF', 'IRIS', 'PERF']		# XXX discontinued
exclusions=['LEIS', 'AOTH', 'HSOC', 'HOME', 'MANU', 'HOSP', 'BUSC' ,'WELS', 'WELF', 'IRIS', 'PERF', 'ECON', 'ENGI', 'OSCI']		# XXX discontinued/low entry
years=[2018,2019]		# XXX
...
# 			grades_data = json.load(grades_file)
# 		for subject in subjects_data:
# 			if subject['flags']['ebacc'] == True:		# XXX
# 				alias=subject['alias']
# 				row=OrderedDict([])
# 				row['alias']=alias
# 				if 'Discontinued' in str(subject['reform_year']['EN']):		# XXX
