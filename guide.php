	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
				...
				<p>Entry and attainment data is provisional data published by the JCQ. Full details of sources used, including sourcing for other information, can be found on the <a href='about.php'>About page</a>.</p>
