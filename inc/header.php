...
<head>
	...
	<link href="/css/style.css?v=20180904" type="text/css" rel="stylesheet" media="screen,projection"/>
	...
	<script src="/js/theme.js?v=20180904"></script>
	<script>
	...
	<nav class="white nav-extended" role="navigation">
		<div class="nav-wrapper container">
			...
			<ul class="right hide-on-med-and-down">
				<li><a href="/">Home</a></li>
				<li><a href="/guide.php?v=20180904">Guide</a></li>
				<li><a class="dropdown-trigger" href="#!" data-target="level-dropdown">A-Level<i class="material-icons right">arrow_drop_down</i></a></li>
				<li><a href="/gcse.php?v=20180904">GCSE</a></li>
				<li><a href="/about.php?v=20180904">About</a></li>
			</ul>
			<ul id="level-dropdown" class="dropdown-content">
				<li><a href="/a-level.php?v=20180904">A-Level</a></li>
				<li><a href="/as-level.php?v=20180904">AS-Level</a></li>
			</ul>
