...
function jsonCallback () {
	return function (data) {
		...
		data.forEach(function (value) {
			...
			var snippet = '<div class="col l4 m6 s12"><div class="card white"><div class="card-content"><h5><a ' + subjectClass + ' href="' + name + '/' + value.subject_name_clean.replace(/\W+/g, '-').toLowerCase() + '.php?v=20200818">' + value.subject_name_clean + '</a></h5></div></div></div>';// done as a single line as IE can't handle template literals
